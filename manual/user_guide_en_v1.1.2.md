# URSP Rule Analyzer User Guide v1.1.2
...
1. Double-click the `URSP-Rule-Analyzer-v1.1.2.exe` file.
...
`URSP-Rule-Analyzer-Lite-v1.1.2.exe` is a lightweight edition that includes only device-supported core features.
